---
source: https://github.com/cursor/plugins/blob/51a96e0dd838404da19ba83dc70aa21eef71f868/pstack/skills/tdd/SKILL.md
name: tdd
...
2. **Choose the narrowest executable check.** Apply [Use Before Build](../principle-use-before-build/SKILL.md) and inspect the closest unit, component, integration, or regression test already used for that codepath. If no practical test path is obvious, do not create one from scratch just to satisfy the workflow.
